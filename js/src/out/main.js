...
$('.toggle-label').click(function() {
  if ($(this).find('.arrow-right').length == 1) {
    $(this).find('.arrow-right').replaceWith('<svg class="arrow-down" xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8"> \
          <path d="M0 0l4 4 4-4h-8z" transform="translate(0 2)" /> \
        </svg>');
    $(this).find('.description').slideDown();
  } else {
    $(this).find('.arrow-down').replaceWith('<svg class="arrow-right" xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8"> \
          <path d="M0 0v8l4-4-4-4z" transform="translate(2)" /> \
        </svg>');
    $(this).find('.description').slideUp();
  }
});
var addBarGraphClicks = function() {
  inMapMode = false;
  $('.bar-graph-viewer').click(function(e) {
    ...
    switch (currentSlide) {
      ...
      case 5:
        ...
        break;
      case 6:
        $("#slide6").trigger("click");
        break;
      case 7:
        $("#slide7").trigger("click");
        break;
      case 8:
        $("#slide8").trigger("click");
        break;
      case 9:
        $("#slide9").trigger("click");
        break;
      case 10:
...
var removeBarGraphClicks = function() {
