...
$('.slide-explore').click( function (e) {
	...
	changeAreaColor(points, 0, 0, total35,"rgba(255, 0, 0, 0.4)");
	// changeAreaColor(0,0,totalTaxBreaks,'green',0.8);
	changeAreaColor(points, 0, 0, totalTaxBreaks,"rgba(255, 0, 0, 0.8)");
	...
	$('.typeahead').bind('typeahead:select', function(ev, suggestion) {
		if(suggestion=='All companies'){
			...
			createProportionGraph(company35+500);  
			console.log(company35);
			// changeAreaColor(0,0,company35,'green',0.4);
			changeAreaColor(points, 0, 0, company35,"rgba(255, 0, 0, 0.4)");
			...
			changeAreaColor(points, 0, 0, companyTaxBreak,"rgba(255, 0, 0, 0.8)");
		}	
	});
});
